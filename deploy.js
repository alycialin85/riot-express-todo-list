...
function transferProjectToRemote(failed, successful) {
  return ssh.putDirectory(
    '../express-riot-todo-list',
    '/home/ubuntu/express-riot-todo-list-temp',
    {
      recursive: true,
      concurrency: 1,
...
function createRemoteTempFolder() {
  return ssh.execCommand(
    'rm -rf express-riot-todo-list-temp && mkdir express-riot-todo-list-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function updateRemoteApp() {
  return ssh.execCommand(
    'mkdir express-riot-todo-list && cp -r express-riot-todo-list-temp/* express-riot-todo-list/ && rm -rf express-riot-todo-list-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function restartRemoteServices() {
  return ssh.execCommand(
    'cd express-riot-todo-list && sudo service mongod start && pm2 start app.js', {
      cwd: '/home/ubuntu'
  });
}
...
function sshConnect() {
  ...
  ssh
    ...
    .then(function() {
      console.log('Creating `express-riot-todo-list-temp` folder.');
